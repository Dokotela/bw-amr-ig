...
final CodeSystem botswanaAMRLocalOrganismCS = CodeSystem.fromJson({
  ...
  "concept": [
    ...
    {"code": "cedecia-lapagei", "display": "Cedecia lapagei"},
    {
    ...
    {"code": "methylobacterium-spp", "display": "Methylobacterium spp."},
    {"code": "moraxella-group", "display": "Moraxella group"},
    {
    ...
    {"code": "myroides-spp", "display": "Myroides spp."},
    {
      "code": "neisseria-animaloris-zoodegmatis",
      "display": "Neisseria animaloris/Neisseria zoodegmatis"
    },
    {"code": "pandoraea-spp", "display": "Pandoraea spp."},
    {"code": "pantoea-spp", "display": "Pantoea spp."},
    {"code": "pseudomonas-spp", "display": "Pseudomonas spp."},
    {"code": "salmonella-group", "display": "Salmonella group"},
    {
      "code": "serratia-liquefaciens-group",
      "display": "Serratia liquefaciens group"
    },
    {"code": "shigella-group", "display": "Shigella group"},
    {
    ...
    {"code": "vagococcus-fluviali", "display": "Vagococcus fluviali"},
    {
